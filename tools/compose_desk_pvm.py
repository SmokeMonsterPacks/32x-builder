...
# THE CONSOLE (models/sega_master_system.glb -> sh_src/sms3d.h, which
# bakes to a single box): authored at real-hardware proportions in desk
# units (~3.3 units/cm: 36.5 x 17 x 7 cm), seated right of the monitor.
# Every pair it forms resolves on one axis — cycle-checked before commit.
console = (30, desk_top, -10, 150, desk_top + 23, 46)
boxes = [mon_f] + desk_f + [console]   # MONITOR FIRST: ftex binds to box 0
